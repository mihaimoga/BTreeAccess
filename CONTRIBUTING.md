...
***Ask not what BTreeAccess can do for you - ask what you can do for BTreeAccess***
...
2. Include additional information such as:
    ...
    * BTreeAccess Debug-Info containing:
...
1. Respect existing BTreeAccess coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
